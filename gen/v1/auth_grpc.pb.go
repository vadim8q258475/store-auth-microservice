...
const (
	...
	AuthService_IsTokenValid_FullMethodName = "/auth.AuthService/IsTokenValid"
)
...
type AuthServiceClient interface {
	...
	IsTokenValid(ctx context.Context, in *IsTokenValid_Request, opts ...grpc.CallOption) (*IsTokenValid_Response, error)
}
...
func (c *authServiceClient) Login(ctx context.Context, in *Login_Request, opts ...grpc.CallOption) (*Login_Response, error) {
...
func (c *authServiceClient) IsTokenValid(ctx context.Context, in *IsTokenValid_Request, opts ...grpc.CallOption) (*IsTokenValid_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsTokenValid_Response)
...
type AuthServiceServer interface {
	...
	IsTokenValid(context.Context, *IsTokenValid_Request) (*IsTokenValid_Response, error)
...
func (UnimplementedAuthServiceServer) IsTokenValid(context.Context, *IsTokenValid_Request) (*IsTokenValid_Response, error) {
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Login(ctx, req.(*Login_Request))
	}
...
func _AuthService_IsTokenValid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).IsTokenValid(ctx, req.(*IsTokenValid_Request))
	}
	return interceptor(ctx, in, info, handler)
}
